// https://gist.github.com/textchimp/798d0760354f9eb7d4906e284dad9f95#file-js-homework-1-md
// The Calculator
// Part 1
...
const percentOf = function(firstNumber, secondNumber) {
  ...
  const percentage = (firstNumber / secondNumber * 100).toFixed(2);
  console.log(`${firstNumber} is ${percentage}% of ${secondNumber}`);
  return percentage;
};

// Write a function called areaOfCircle that will take one argument (the radius),
// calculate the area based on that, and return the result. It should also log
// a string like "The area for a circle with radius 2 is 12.566370614359172."
