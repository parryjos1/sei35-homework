console.log("YERRRR the one with hackaround!!!");
    ...
    if (departureStationIndex > destinationStationIndex && startLine === finishLine) {
      ...
      return ( `To get there you must travel ${journey.length} stops, these include ${journey}, exiting at ${destinationStation} `);
          ...
          // console.log(journey);
           ...
           if (changeIndexStart < departureStationIndex && changeIndexEnd < destinationStationIndex) {
                ...
                return (`To get there you must travel ${journey.length} stops, ${journey}. Change at Union Square onto the ${ destinationLine }. From there you must travel ${secondLegNoReverse.length} stops,  ${secondLegNoReverse}, exiting at ${destinationStation} `);

            } else if (startLine !== finishLine && changeIndexStart < departureStationIndex && changeIndexEnd > destinationStationIndex) {
