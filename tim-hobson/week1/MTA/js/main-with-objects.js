...
//  TRYING TO MAKE A SOLE TRIP FUNCTION
{
// sameLineTravel: function (destinationLine, originStation, destinationStation) {
//   console.log(`You're on Line ${destinationLine} and want to go from ${originStation} to ${destinationStation}.`);
//   startIndex = this.stations[destinationLine].indexOf( originStation ) // take originStation, and find it's index in destinationLine
...
// singleLineTrip: function (originLine, originStation, destinationLine, destinationStation) {
//   console.log(originLine, originStation, destinationLine, destinationStation); // log to test
//   if ( originLine === destinationLine ) {  // do sameLineTravel
//     console.log('This will be same line travel');
//   } else if ( originStation === "Union Square" ) { //do the trip to interchange
//     console.log('this will be travel to interchange');
//   } else if ( destinationStation === "Union Square" ){ //do the trip from interchange
//     console.log('this will be travel from interchange');
//   }
  // console.log(`You're at ${originStation} on Line ${originLine} You have to change from Line ${originLine} to Line ${destinationLine}.`);
  // startIndex = this.stations[ originLine ].indexOf( originStation ) // take originStation on originLine , and find it's index.
  // endIndex = this.stations[originLine].indexOf("Union Square") // take Union Square(the interchange) and find it's index.
  ...
  // mta.singleLineTrip( '6', 'Grand Central', 'N', '8th')
  // mta.singleLineTrip( '6', 'Grand Central', '6', 'Union Square')
  // mta.singleLineTrip( '6', 'Grand Central', '6', 'Astor Place')
